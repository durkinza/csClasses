...
\section{Problem 1.4 \cite[p.~38]{stallings}}
...
\item An organization managing public information on its Web server\cite[p.~38]{stallings}.
	...
	\end{description}
\item A law enforcement organization managing extremely sensitive investigative information \cite[p.~38]{stallings}.
	\begin{description}[leftmargin=!, labelwidth=\widthof{\bfseries Confidentiality}]
	...
	\end{description}
\item A financial organization managing routine administrative information (not privacy- related information)\cite[p.~38]{stallings}.
	\begin{description}[leftmargin=!, labelwidth=\widthof{\bfseries Confidentiality}]
	...
	\end{description}
\item An information system used for large acquisitions in a contracting organization contains both sensitive, pre-solicitation phase contract information and routine administrative information. Assess the impact for the two data sets separately and the information system as a whole\cite[p.~38]{stallings}.
	\begin{description}[leftmargin=!, labelwidth=\widthof{\bfseries Confidentiality}]
	...
	\end{description}
\item A power plant contains a SCADA (supervisory control and data acquisition) system controlling the distribution of electric power for a large military installation. The SCADA system contains both real-time sensor data and routine administration information. Address the impact for the two data sets separately and the information systems as a whole \cite[p.~38]{stallings}.
	\begin{description}[leftmargin=!, labelwidth=\widthof{\bfseries Confidentiality}]
...
\section{Problem 1.7 \cite[p.~39]{stallings}}
